...
public class DestinationBearingRead : ROSBridgeSubscriber {
	public static float destinationBearing;
	...
	public new static void CallBack(ROSBridgeMsg msg) {
		Float32Msg destinationBear = (Float32Msg) msg;
        destinationBearing = destinationBear.GetData ();
	}
}